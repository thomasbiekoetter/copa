module copa__independent_parallel_sampler
  ...
  public :: run_independent_parallel_sampler
...
contains
  ...
  subroutine run_independent_parallel_sampler(  &
  ...
  end subroutine run_independent_parallel_sampler

end module copa__independent_parallel_sampler
